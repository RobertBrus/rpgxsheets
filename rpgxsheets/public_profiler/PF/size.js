...
function OnSizeChanged()
{
  ...
  RBABCalc();
  sheet().CMBSize.value = Clean(CMSizeModifiers[sheet().Size.value.charAt(0).toLowerCase()]);
  CMBBABCalc();
  sheet().CMDSize.value = Clean(CMSizeModifiers[sheet().Size.value.charAt(0).toLowerCase()]);
  CMDBABCalc();
